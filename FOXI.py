...
NAME_file_writer.writerow(['Name','Z','dZ','Source Strength','Start Time','Stop Time'])
NAME_file_min.close()
weather_file_avg = open(out_txt+ "_weather_data_havg.txt", "a",encoding="utf-8", errors="surrogateescape")
...
weather_file_max = open(out_txt+ "_weather_data_hmax.txt", "a",encoding="utf-8", errors="surrogateescape")
...
weather_file_min = open(out_txt+ "_weather_data_hmin.txt", "a",encoding="utf-8", errors="surrogateescape")
